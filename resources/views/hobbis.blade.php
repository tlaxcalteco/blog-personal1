					...
					<header id="header">
						...
						<nav>
							<ul>
								...
								<li><a href="#work">HOBBIS</a></li>
								<li><a href="#FAV">MUSICA PRE</a></li>
					...
					<div id="main">
						...
						<!-- Work -->
							<article id="work">
								...
								<p>1)Escuchar musica.</p>
								<p>2)Convivir con mi familia.</p>
								<p>3)Convivir con mis amigos.</p>
								<p>4)Ver peliculas.</p>
								<p>5)Jugar videojuegos.</p>
							</article>

						<!-- About -->
							<article id="about">
								<h2 class="major">METAS</h2>
								<span class="image main"><img src="images/pic03.jpg" alt="" /></span>
								<h2>CORTO PLAZO </h2>
								<p>A corto plazo es poder terminar mi carrera y graduarme como ingeniro.</p>
								<h2>MEDIANO PLAZO </h2>
								<p>A mediano plazo es poder laborar para una empresa reconocida como desarrollador.</p>
								<h2>LARGO PLAZO </h2>
								<p>A largo plazo es estudiar una licenciatura en administracion de empresas y poder estar laborando en otro pais.</p>
							</article>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy;GRUPO: 3522IS ING.SOFTWARE</p>
					</footer>
